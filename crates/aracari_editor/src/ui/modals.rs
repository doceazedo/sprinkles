...
use crate::ui::styles::{
    ...
    primary_button, styled_radio, MODAL_FOOTER_PADDING, TEXT_LG,
};
...
pub fn poll_open_file_dialog(mut dialog_state: ResMut<OpenFileDialogState>, mut commands: Commands) {
    if !dialog_state.is_open {
        return;
    }
